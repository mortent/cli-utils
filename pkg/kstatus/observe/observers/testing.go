...
type newResourceObserverFunc func(reader reader.ObserverReader, mapper meta.RESTMapper) ResourceObserver
...
func (f *fakeResourceObserver) SetComputeStatusFunc(_ ComputeStatusFunc) {}
